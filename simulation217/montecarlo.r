...
library(simsalapar)
library(parallel)
setwd("~/Senior_Seminar/simulation217/")
...
## This runs the simulations on the cluster and outputs the result to output217.rds
...
file.exists("output217.rds")
if(file.exists("output217.rds")) {
  file.rename("output217.rds", "simulation217/output217.rds")
}
