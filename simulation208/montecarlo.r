...
library(simsalapar)
library(parallel)
setwd("~/Senior_Seminar/simulation208/")
...
mem_list <<- seq(20, 20, 10)
pupdate_list <<- seq(0.5, 0.9, 0.2)
...
## This runs the simulations on the cluster and outputs the result to output208.rds
...
file.exists("output208.rds")
if(file.exists("output208.rds")) {
  file.rename("output208.rds", "simulation208/output208.rds")
}
